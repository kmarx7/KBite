...
export const PRICE_STEPS: Record<PriceCurrency, PriceSteps> = {
  KRW: {
    min: [null, 5000, 10000, 15000, 20000, 30000, 50000, 70000, 100000, 150000, 200000, 300000],
    max: [5000, 10000, 15000, 20000, 30000, 50000, 70000, 100000, 150000, 200000, 300000, null],
  },
  USD: {
    min: [null, 5, 10, 15, 20, 30, 50, 100, 150, 200, 300, 500],
    max: [5, 10, 15, 20, 30, 50, 100, 150, 200, 300, 500, null],
  },
};
